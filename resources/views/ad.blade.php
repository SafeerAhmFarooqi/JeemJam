...
<div style="width:100%;border:1px solid grey;background-color:white;">
    ...
    <center> <div class="des" style=";width:80%;margin-top:5px;">
    <div style="border:1px solid black">
            <div style="width:100%">
        <img style="width:500px;height:500px;margin-left:5px;" src="{{asset('img/'.$data->img)}}" alt="logo">
        </div>@if($data->img2!="na")
        <img style="width:23%;height:150;margin-left:5px;border-right:1px solid black;;border-top:1px solid black" src="{{asset('img/'.$data->img2)}}" alt="logo">
        @endif
        @if($data->img3!="na")
        <img style="width:23%;height:150;margin-left:5px;border-right:1px solid black;;border-top:1px solid black" src="{{asset('img/'.$data->img3)}}" alt="logo">
        @endif
        @if($data->img4!="na")
        <img style="width:23%;height:150;margin-left:5px;border-right:1px solid black;;border-top:1px solid black" src="{{asset('img/'.$data->img4)}}" alt="logo">
        @endif
        @if($data->img5!="na")
        <img style="width:23%;height:150;margin-left:5px;border-right:1px solid black;;border-top:1px solid black" src="{{asset('img/'.$data->img5)}}" alt="logo">
        @endif</div>
        <h1 style="margin-top:35px;">{{$data->title}}</h1>
        <h3  style="margin-top:15px;">{{$data->content}} </h3> 
         <br>
        <br>
        <h4> Phone Number: {{$data->phone}}</h4>
        <br>
        <h4> Whatsapp Number:  {{$data->whatsapp}}</h4>
    </div></center>
        <center> <div class="mob" style=";width:100%;margin-top:5px;">
    <div style="border:1px solid black">
            <div style="width:100%">
        <img style="width:90%;height:400px;margin-left:5px;" src="{{asset('img/'.$data->img)}}" alt="logo">
        </div>@if($data->img2!="na")
        <img style="width:23%;height:150;margin-left:5px;border-right:1px solid black;;border-top:1px solid black" src="{{asset('img/'.$data->img2)}}" alt="logo">
        @endif
        @if($data->img3!="na")
