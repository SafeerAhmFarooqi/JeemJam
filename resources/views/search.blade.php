...
<div style="width:98%;border:1px solid grey;background-color:white;">
    ...
    @if($postCount==0 )
    <center><h2>No Post found</h2></center>
    @endif
    @foreach($postData as $data)
        ...
        <h6>{{substr($data->content,0,100)}} </h6>  
         <a class="des" href="{{url('post/'.$data->id.'/ad')}}">Show More</a>
      <a class="mob" style="float:right" href="{{url('post/'.$data->id.'/ad')}}">Show More</a>
    </div>
    @endforeach
